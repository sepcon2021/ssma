...
class GeneratePDF
{
    ...
    public function generateIncidenciaOficialPdf($documento)
    {
        ...
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(80, 6, utf8_decode($documento['lugar']), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(10, 6, 'Fecha:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, date('d/m/Y', strtotime($documento['fecha'])), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(10, 6, 'Hora:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode($documento['hora']), 0, 1);

        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(180, 6, "LUGAR Y HORA DEL ACCIDENTE/INCIDENTE/ENFERMEDAD OCUPACIONAL", 0, 1, 'C');
        $pdf->Cell(55, 6, 'NOMBRE DE LA PERSONA INVOLUCRADA: ', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(80, 6, utf8_decode($documento['persona']), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'DNI/CE : ', 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(50, 6, utf8_decode($documento['documento']), 0, 1);
        $pdf->Cell(10, 6, 'SEXO: ', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(30, 6, utf8_decode($documento['sexo'] = "MA" ? "MASCULINO" : "FEMENINO"), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'EDAD : ', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(20, 6, utf8_decode($documento['edad']), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'CUENTA CON SEGURO (SI/NO) ESPECIFICAR: ', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode($documento['seguro']), 0, 1);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(45, 6, 'LUGAR Y FECHA DE NACIMIENTO:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(80, 6, utf8_decode($documento['nacimiento']), 0, 1);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(20, 6, 'DOMICILIO:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(60, 6, utf8_decode(strtoupper($documento['domicilio'])), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(20, 6, 'ESTADO CIVIL:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        switch ($documento['civil']) {
            case 'CO':
        ...
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode(strtoupper($documento['dpto'])), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'PROVINCIA:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode(strtoupper($documento['prov'])), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'DISTRITO:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode(strtoupper($documento['dist'])), 0, 1);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(15, 6, 'CARGO:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode($documento['cargo']), 0);
        $pdf->SetFont('Helvetica', 'B', 7);
        $pdf->Cell(20, 6, 'INSTRUCCION:', 0);
        $pdf->SetFont('Helvetica', '', 7);
        $pdf->Cell(50, 6, utf8_decode($documento['instruccion']), 0, 1);
