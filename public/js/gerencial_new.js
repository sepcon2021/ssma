$(function () {
    ...
    */
    ...
    $("#formDigital").submit(function (e) {
        ...
        $.post(RUTA + 'gerencial/grabarDocumentoWebNew', str, function (data, textStatus, xhr) {
            $(".wrap_load").hide();
            $(".wrap_sucess").show();
    ...
    */
    ...
    function answerValidateCampos() {
        ...
        let listCampos = [
            ...
            { "campo": "tipo_actividad", "tipo": SELECT },
            { "campo": "responsable_area", "tipo": INPUT },
            { "campo": "numero_trabajadores", "tipo": INPUT },
            { "campo": "area_inspeccionado", "tipo": INPUT },
            { "campo": "fecha_inspeccion", "tipo": DATE },
            { "campo": "responsable_inspeccion", "tipo": INPUT },
            { "campo": "notas1", "tipo": INPUT },
            { "campo": "visita", "tipo": INPUT },
            { "campo": "notas2", "tipo": INPUT },

            { "campo": "responsable_area", "tipo": INPUT },
            { "campo": "cargo", "tipo": INPUT },
