$(function () {
    ...
    $('#lista_proyecto').on('change', function() {
        ...
        changeBotiquinForm(idProyecto);

    });

    function changeBotiquinForm(idProyecto){
        if(idProyecto == 5){
            $("#contenidoCabecera").load("views/inspeccionBotiquin/cabeceraLima.html"); 
        }else{
            $("#contenidoCabecera").load("views/inspeccionBotiquin/cabeceraOtros.html");         }
    }
    ...
    $("#formulario").on('submit', function (event) {
        ...
        $.post(RUTA + 'inspeccionBotiquin/insert', json, function (data, textStatus, xhr) {
