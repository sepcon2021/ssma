$(function () {
    ...
    $("#formulario").on('submit', function (event) {
        ...
        $.post(RUTA + 'inspeccionEstacionEmergencia/insert', json, function (data, textStatus, xhr) {
    ...
    $("#formpopup").on('submit', function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(`#tablaClasificacion tbody tr:eq(${index}) td:eq(7) textarea.archivos`).html(listaArchivo);
