	...
	<div id="wrap">
		<div class="page">
			<div class="cabeceraDoc">
				...
				<div class="titulo">
					<p>INSPECCIÓN DE OFICINAS</p>
				</div>
				<div class="formato">
					<p>PSPC-110-X-PR-001-FR-011</p>
					<p>Revisión: 0</p>
			...
			<form method="POST" id="formulario" name="formulario">
                ...
                <div class="manyInput">
                    <div class="w60p">
                        ...
                        <input id="inspeccionado_por" type="text" name="inspeccionado_por" id="inspeccionado_por" class="w90p">
                    </div>
                </div>
                ...
                <div class="manyInput">
                    <div class="w60p">
                        ...
                        <input type="text" name="responsable_area" id="responsable_area" class="w90p">
                    </div>
                </div>
-->
				<div class="manyInput">
	...
	<script src="<?php echo constant('URL'); ?>public/js/inspeccionesOficinas.js?<?php echo constant('VERSION'); ?>"></script>
